                ...
                <div className="space-y-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            placeholder="https://wa.me/233xxxxxxxxx or https://chat.whatsapp.com/..."
                            className="w-full border border-gray-200 rounded-lg px-4 py-3 text-sm focus:ring-2 focus:ring-primary focus:border-primary outline-none"
                        />
                        <p className="mt-1 text-xs text-gray-500">
                            This link will appear as a floating button for customers to contact support or join your channel.
                        </p>
                    </div>
