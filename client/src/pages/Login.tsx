...
import { Wifi, ArrowRight, Lock } from 'lucide-react';
        ...
        <div className="min-h-screen bg-[#050B14] text-white overflow-hidden relative flex items-center justify-center selection:bg-yellow-500/30">
            ...
            <div className="w-full max-w-md p-6 relative z-10">
                ...
                <div className="text-center mb-8">
                    ...
                    <h2 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-white to-gray-400">Welcome Back</h2>
                    <p className="text-gray-400 mt-2 text-sm">Sign in to manage your premium data bundles</p>
                </div>
                    ...
                    <form onSubmit={handleLogin} className="space-y-5">
                        <div className="space-y-1.5">
                            ...
                            <input
                                ...
                                className="w-full p-4 rounded-xl bg-black/30 border border-white/10 text-white placeholder-gray-600 focus:outline-none focus:border-yellow-500/50 focus:ring-1 focus:ring-yellow-500/50 transition-all"
                        ...
                        <div className="space-y-1.5">
                            <div className="flex justify-between items-center ml-1">
                                ...
                                <a href="#" className="text-xs text-yellow-500/80 hover:text-yellow-400">Forgot?</a>
                            </div>
                            <input
                                type="password"
                                value={password}
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full py-4 bg-gradient-to-r from-yellow-500 to-yellow-600 text-black font-bold text-lg rounded-xl hover:shadow-[0_0_20px_rgba(234,179,8,0.3)] hover:scale-[1.02] active:scale-[0.98] transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 mt-4"
                        >
                            {loading ? 'Signing in...' : (
                ...
                <p className="mt-8 text-center text-sm text-gray-500">
                    Don't have an account? <Link to="/register" className="text-yellow-500 hover:text-yellow-400 font-semibold transition-colors">Create Account</Link>
                </p>
            </div>
        </div>
    );
